	                 ...
	                 var imgJson = {
	                    ...
	                    avatar: userImage,
	                     ...
	                     UpdateUserImg(imgJson).then((response: any) => {
	                        ...
	                        return(
    <nav id="ighf" data-gjs="navbar" className="gdp-row gpd-grid sticky ">
<div id="ik48" className="gpd-clm gpd-cell ">
<div id="ij0o8m" className="gdp-row gpd-grid ">
<div id="template-i2uji" className="">
<div  onClick={openNav} id="i8h3sg"  className="gpd-clm gpd-cell ">
...
<div id="ip9j7w" className="gpd-clm gpd-cell ">
...
<div id="mySidenav" data-gjs="navbar-items" className="sidenav ">
<div  id="template-if7ki" className="closebtn ">
<div onClick={closeNav}  id="ibuiwl" className="gpd-clm gpd-cell ">
